...
class ToolTest extends TestCase
{
    ...
    public function testToolAddsVersion(): void
    {
        ...
        $tool->addVersion($version1 = new ToolVersion('supertool', '1.0.0', null, null, null, null));
        $tool->addVersion($version2 = new ToolVersion('supertool', '2.0.0', null, null, null, null));
    ...
    public function testToolThrowsWhenAddingAVersionForAnotherTool(): void
    {
        ...
        $tool->addVersion(new ToolVersion('anothertool', '1.0.0', null, null, null, null));
    }
    ...
    public function testToolThrowsWhenAddingAVersionTwice(): void
    {
        ...
        $tool->addVersion(new ToolVersion('supertool', '1.0.0', null, null, null, null));
        $tool->addVersion(new ToolVersion('supertool', '1.0.0', null, null, null, null));
    }
